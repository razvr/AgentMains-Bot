...
class MockClient {
  constructor(client = {}) {
    console.warn("MockClient is deprecated and will be removed in v6.");
...
class MockClientUser {
  constructor(clientUser = {}) {
    console.warn("MockClientUser is deprecated and will be removed in v6.");
...
class MockGuild {
  constructor(guild = {}) {
    console.warn("MockGuild is deprecated and will be removed in v6.");
...
class MockUser {
  constructor(user = {}) {
    console.warn("MockUser is deprecated and will be removed in v6.");
...
class MockRole {
  constructor(role = {}) {
    console.warn("MockRole is deprecated and will be removed in v6.");
...
class MockChannel {
  constructor(channel = {}) {
    console.warn("MockChannel is deprecated and will be removed in v6.");
...
class MockGuildMember {
  constructor(guildMember = {}) {
    console.warn("MockGuildMember is deprecated and will be removed in v6.");
...
class MockMessage {
  constructor(message = {}) {
    console.warn(
      "MockMessage is deprecated and will be removed in v6. " +
      "Please use createMessage on a stubbed chaos bot instead.",
    );
