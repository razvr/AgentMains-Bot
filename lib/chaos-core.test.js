...
const { Observable, of, EMPTY } = require('rxjs/index');
const { tap, flatMap, catchError, toArray } = require('rxjs/operators/index');
...
const { MockClient, MockUser } = require("./test/mocks/discord.mocks");
