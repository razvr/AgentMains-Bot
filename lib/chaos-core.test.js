...
describe('ChaosCore', function () {
  beforeEach(function () {
    ...
    this.owner = new MockUser(this.discord, {
  ...
  describe('#listen', function () {
    ...
    it('emits event in the correct order', async function () {
      ...
      this.guild1 = new MockGuild(this.chaos.discord);
    ...
    describe('bootstrap process', function () {
      ...
      context('when the bot has joined guilds', function () {
        beforeEach(function () {
          ...
          this.chaos.discord.guilds.cache.set(this.guild1.id, this.guild1);
          this.chaos.discord.guilds.cache.set(this.guild2.id, this.guild2);
          this.chaos.discord.guilds.cache.set(this.guild3.id, this.guild3);
        });
      ...
      context('when the owner can not be found', function () {
        beforeEach(function () {
          ...
          sinon.stub(this.chaos.discord.users, 'fetch').rejects(this.error);
        });
  ...
  describe('#createEmbedForError', function () {
    ...
    it('returns an MessageEmbed', function () {
      expect(this.chaos.createEmbedForError(this.error)).to.be.an.instanceOf(Discord.MessageEmbed);
    });
