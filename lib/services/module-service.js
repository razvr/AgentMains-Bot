...
const ERRORS = {
  ...
  COULD_NOT_ENABLE: 'Could not enable module',
  MODULE_ALREADY_DISABLED: 'Module is already disabled',
  COULD_NOT_DISABLE: 'Could not disabled module',
};
...
class ModuleService {
  ...
  enableModule(guildId, moduleName) {
    ...
    return this.isModuleEnabled(guildId, module.name)
      ...
      .flatMap((savedData) => this.nix.dataService.setGuildData(guildId, DATAKEYS.ENABLED_MODULES, savedData))
