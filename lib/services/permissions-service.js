...
class PermissionsService {
  ...
  getPermissionsData(guildId, level) {
    ...
    return this.nix.dataService.getGuildData(guildId, this.getDatakey(level))
      .flatMap((savedData) => {
        if (!savedData) {
  ...
  setPermissionsData(guildId, level, data) {
    ...
    return this.nix.dataService.setGuildData(guildId, this.getDatakey(level), data);
  }
  ...
  hasPermission(context, commandName) {
    let command = this.nix.commandService.commands[commandName];
