...
describe('Service: UserService', function () {
  beforeEach(function () {
    ...
    this.guild = {};
    this.guild.members = new Discord.GuildMemberManager(this.guild);
      ...
      context("when the userString is an user's username", function () {
        ...
        context('when multiple users have the same username', function () {
          beforeEach(function () {
            ...
            this.chaos.discord.users.cache.set(this.otherUser.id, this.otherUser);
            this.guild.members.cache.set(this.otherMember.id, this.otherMember);
          });
