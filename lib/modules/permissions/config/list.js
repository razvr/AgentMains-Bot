...
module.exports = {
  ...
  run(context, response) {
    ...
    response.embed.addField("Bot Owner\* - *bypasses permissions*", context.nix.owner.tag);
    response.embed.addField("Guild Owner\* - *bypasses permissions*", context.guild.owner.user.tag);
