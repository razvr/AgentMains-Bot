  ...
  run: (context, response) => {
    ...
    return nix.moduleService
      ...
      .flatMap((isEnabled) => {
        ...
        return nix.dataService.getGuildData(context.guild.id, 'core.enabledModules');
      })
      .flatMap((savedData) => {
        savedData[moduleName] = false;
        return nix.dataService.setGuildData(context.guild.id, 'core.enabledModules', savedData);
      })
      .flatMap((savedData) => {
