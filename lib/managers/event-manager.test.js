...
describe('EventManager', function () {
  ...
  describe('#addEventHandler', function () {
    ...
    it('adds a handler', function () {
      ...
      this.eventManager.addEventHandler('test', handler);
    ...
    it('adds a before handler', function () {
      const handler = sinon.fake();
      this.eventManager.addEventHandler('test:before', handler);
    ...
    it('adds an after handler', function () {
      const handler = sinon.fake();
      this.eventManager.addEventHandler('test:after', handler);
  ...
  describe('#triggerEvent', function () {
    ...
    it('triggers handlers in order', function (done) {
      ...
      this.eventManager.addEventHandler('test:before', beforeHandler);
      this.eventManager.addEventHandler('test', handler);
      this.eventManager.addEventHandler('test:after', afterHandler);
