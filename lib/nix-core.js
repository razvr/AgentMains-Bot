...
const { handleNixHook } = require("./utility");
...
class NixCore {
  ...
  constructor(config) {
    ...
    this.handleHook = (hookReturnValue) => {
      this.logger.warn("nix#handleHook is deprecated. Please import and use NixCore.utility.handleNixHook");
      return handleNixHook(hookReturnValue);
    };
